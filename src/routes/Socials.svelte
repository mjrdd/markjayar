<div class="my-8 flex flex-wrap justify-center gap-3 lg:text-xl" data-sveltekit-preload-data="off">
	<a href="/youtube" class="btn" style:--custom-text-color="#ff0000">
	...
	<a href="/twitter" class="btn" style:--custom-text-color="#00acee">
		<svg width="1em" height="1em" viewBox="0 0 16 16">
			<path
				fill="currentColor"
	...
	<a href="/instagram" class="btn" style:--custom-text-color="#bc2a8d">
		<svg width="1em" height="1em" viewBox="0 0 16 16">
			<path
				fill="currentColor"
	...
	<a href="/twitch" class="btn" style:--custom-text-color="#6441a5">
		<svg width="1em" height="1em" viewBox="0 0 16 16">
			<g fill="currentColor">
				<path
					d="M3.857 0L1 2.857v10.286h3.429V16l2.857-2.857H9.57L14.714 8V0H3.857zm9.714 7.429l-2.285 2.285H9l-2 2v-2H4.429V1.143h9.142v6.286z" /><path
					d="M11.857 3.143h-1.143V6.57h1.143V3.143zm-3.143 0H7.571V6.57h1.143V3.143z" />
			</g>
		</svg>
	</a>
	<a href="/github" class="btn" style:--custom-text-color="#171515">
		<svg width="1em" height="1em" viewBox="0 0 16 16">
			<path
				fill="currentColor"
	...
	<a href="/tiktok" class="btn" style:--custom-text-color="#ff0050">
		<svg width="1em" height="1em" viewBox="0 0 16 16">
			<path
				fill="currentColor"
...
<style lang="postcss">
	.btn {
		@apply grid aspect-square w-10 place-items-center rounded-full lg:w-12;
		@apply text-neutral-300 hover:bg-white hover:bg-opacity-10;
